 ...
 */
abstract class PLCO_REST_Controller {
	 ...
	 */
	public static $namespace = 'plco/v';
	...
	public function jwt_permissions_check($request) {
		$jwt = str_replace('Bearer ', '',$request->get_header('authorization'));
	 ...
	 * @return bool
	 */
	public function no_permission_required() {
		return true;
	}
